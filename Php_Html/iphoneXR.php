...
<?php
 ...
 <html lang="en" dir="ltr">
   <head>
     <meta charset="utf-8">
     <link rel="stylesheet" href="/css/iPhoneXR.css">
     <title>iPhone</title>
   </head>
   <body>
     ...
     <div class="main_introduce">
       <ul>
         <li><strong>완전히 새롭게 선보이는 Liquid Retina 디스플레이는 업계</strong></li>
         <li><strong>최고의 LCD입니다. 여기에 더욱 빨라진 Face ID, 스마트폰</strong></li>
         <li><strong>사상 가장 스마트하고 강력한 칩, 혁신적인 카메라 시스템까지.</strong></li>
         <li><strong>iPone X</strong>R<strong>. 어느 모로 보나 아릅답죠</strong></li>
         <p class="main_introduce_small"><strong>출시일은 추후 공개됩니다.</strong></p>
       </ul>
     </div>
     <div class="img_section">
        <ul>
          <li><strong>iPhone의 새로운 세대</strong></li>
        </ul>
     </div>
     <div class="desc">
       <img src="/img/iphonexr_desc.png" width="100%">
     </div>
