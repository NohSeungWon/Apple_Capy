<?php
 ...
 $conn = mysqli_connect(
   ...
   'password',
   'server file name');
 $sql = "SELECT * FROM boardinfo where idx='{$_GET['fix']}'"; // table 정보 담기
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <form action="board_fix_active.php" method=post>
        ...
        <tr>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td align=left >
                        <TEXTAREA name=texture cols=65 rows=15><?php echo $row['texture']; ?></TEXTAREA>
                    </td>
                </tr>
                <tr>
